      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-800 bg-slate-900/80 p-8 shadow-xl backdrop-blur">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm text-slate-400">
            Join the dashboard to manage your case studies, testimonials, and portfolio content.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400">
          Already registered?{" "}
          <Link className="font-medium text-primary-300 hover:text-primary-200" href="/login">
            Sign in
          </Link>
        </p>
      </div>
