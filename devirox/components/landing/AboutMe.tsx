...
export default function AboutMe() {
  ...
  return (
    <section className="relative w-full overflow-hidden py-16 md:py-24" id="about">
      {/* Background pattern */}
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          >
            Building scalable and performant web applications with Next.js, TypeScript, and AWS.
          </motion.p>
        </div>
        ...
        <div ref={aboutRef} className="relative mx-auto mb-20">
          <div className="grid gap-16 md:grid-cols-2">
            ...
            >
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                To craft modern, user-friendly web applications that help businesses scale while delivering exceptional user experiences.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                To become a recognized full-stack developer creating innovative, cloud-ready applications with modern technologies like Next.js and AWS.
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              I specialize in building full-stack applications with a focus on performance, scalability, and smooth user interfaces. From front-end design to backend deployment on AWS, I deliver complete solutions for modern web projects.
            </p>
          </motion.div>
        </div>
            ...
            {[
              {
                ...
                description: 'Began learning web development, mastering HTML, CSS, and JavaScript.',
              },
              {
                year: '2018',
                title: 'Full-Stack Development',
                description: 'Expanded skills to Next.js, React, Node.js, and databases.',
              },
              {
                year: '2021',
                title: 'AWS Deployment',
                description: 'Started deploying scalable applications to AWS for real clients.',
              },
              {
                year: '2024',
                title: 'Portfolio Launch',
                description: 'Showcasing my projects and skills on this professional portfolio.',
              },
            ].map((item, index) => (
              <motion.div
                key={index}
